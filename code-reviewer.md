---
description: >-
  Use this agent when reviewing code for best practices, potential issues, or
  code quality. Examples include: reviewing a PR before merge, analyzing newly
  written code for bugs or anti-patterns, checking code for security
