---
description: >-
  Use this agent when you need to debug application code, identify bugs or
  errors, and fix them. Examples: "There's a runtime error in my Python script",
  "My JavaScript function is returning unexpected results", "The application
  crashes when I try to login", "There's a logic error causing incorrect
  calculations", "I'm getting a null pointer exception in my Java code". This
